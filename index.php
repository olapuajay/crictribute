...
<body>
    ...
    <div id="intro">
        <span style="color: #320320; font-family: Georgia, serif; font-size: xx-large; ">Welcome, Cricket Enthusiasts</span><br><br>This platform is a heartfelt homage to the captivating world of cricket,
    ...
    <div class="container py-5">
        <div class="row text-center text-darkblue">
            <div class="col-lg-8 mx-auto">
                ...
                <p class="lead mb-0" style="font-family: serif; font-size: x-larger;">CricTribute was born out of a shared passion for cricket and a desire to create a 
    ...
    <div class="container mt-3">
        <div class="row text-center justify-content-center">
            <div class="col-xl-3 col-sm-6 mb-5 team-card">
                <div class="bg-white rounded shadow-sm py-5 px-4"><img src="utils\img/OI2.jpg" alt="" width="150" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-lg">
                    <h5 class="mb-0">MITCHELL</h5>
                    <span class="small text-uppercase text-muted">CEO - Founder</span>
                    <ul class="social mb-0 list-inline mt-3">
                        <li class="list-inline-item"><a href="#" class="social-link"><i class="fa-brands fa-facebook"></i></i></a></li>
            ...
            <div class="col-xl-3 col-sm-6 mb-5 team-card">
                <div class="bg-white rounded shadow-sm py-5 px-4"><img src="utils\img/vk.jpg" alt="" width="150" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-lg">
                    <h5 class="mb-0">VIRAT KOHLI</h5>
                    <span class="small text-uppercase text-muted">Brand Ambassador</span>
                    <ul class="social mb-0 list-inline mt-3">
                        <li class="list-inline-item"><a href="#" class="social-link"><i class="fa-brands fa-facebook"></i></i></a></li>
                        <li class="list-inline-item"><a href="#" class="social-link"><i class="fa-brands fa-twitter"></i></a></li>
                        <li class="list-inline-item"><a href="#" class="social-link"><i class="fa-brands fa-instagram"></i></a></li>
            ...
            <div class="col-xl-3 col-sm-6 mb-5 team-card">
                <div class="bg-white rounded shadow-sm py-5 px-4"><img src="utils\img/dev_1.jpg" alt="" width="150" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-lg">
            ...
            <div class="col-xl-3 col-sm-6 mb-5 team-card">
                <div class="bg-white rounded shadow-sm py-5 px-4"><img src="utils\img/OI1.jpg" alt="" width="150" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-lg">
                    <h5 class="mb-0">CHRISTINA</h5>
